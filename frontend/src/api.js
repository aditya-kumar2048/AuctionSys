...
export const updateOwner = (ownerId, data) => axios.patch(`${API_URL}/owners/${ownerId}`, { totalBudget: data })
.then(res => res.data);
...
export const updatePlayer = (playerId, data) => axios.patch(`${API_URL}/players/${playerId}`, data).then(res => res.data);
